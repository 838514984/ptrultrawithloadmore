...
import com.example.administrator.ptrultrawithloadmore.R;
import com.example.administrator.ptrultrawithloadmore.util.CollectionUtils;
import com.example.administrator.ptrultrawithloadmore.util.CompatUtil;
...
public abstract class BaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewAdapter.VH> {
    ...
    public static class VH extends RecyclerView.ViewHolder {
        ...
        public void setImageResourec(int imageViewId, String url, int placeHolder){
            ...
            if(v !=null){
                Glide.with(v.getContext().getApplicationContext()).load(url).centerCrop().error(placeHolder).placeholder(placeHolder).into(v);
            }
        }
        public void setImageResourec(int imageViewId, @DrawableRes int drawableId){
            ImageView v = get(imageViewId);
            if(v !=null){
                v.setImageDrawable(CompatUtil.getDrawable(drawableId));
            }
        }
    ...
    public void onBindViewHolder(VH viewHolder, int position) {
        ...
        if (getItemViewType(position) < HEADER_TYPE) {
            ...
            if (CollectionUtils.isValid(mClickIds)) {
